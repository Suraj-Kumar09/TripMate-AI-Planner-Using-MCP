...
client = MultiServerMCPClient(
    {
        ...
        "weather": {
            "transport": "stdio",
            "command": r"C:\Users\asus\anaconda3\envs\travel\python.exe",
            "args": [
                r"C:\End-to-End Multi-Agent AI System with LangGraph, MCP, Supervisor, Guardrails Safety & HITL\TripMate-AI-Planner-Using-MCP\custom_weather_mcp_server.py"
            ],
            "env": {
